...
@onready var current_pulp_label = $MainContainer/VBoxContainer/CurrentPulpLabel
@onready var synapse_button = $MainContainer/VBoxContainer/SynapseRow/Synapse_Button
@onready var chroma_scales_button = $MainContainer/VBoxContainer/PillarsContainer/Pillar1/Pillar1_Button
@onready var serpents_coffer_button = $MainContainer/VBoxContainer/PillarsContainer/Pillar2/Pillar2_Button
@onready var geode_compass_button = $MainContainer/VBoxContainer/PillarsContainer/Pillar3/Pillar3_Button
@onready var four_leaf_button = $MainContainer/VBoxContainer/PillarsContainer/Pillar4/Pillar4_Button
@onready var rand_item_button = $MainContainer/VBoxContainer/RouletteContainer/RotatingItemRow/RotatingItemButton
@onready var rand_item_description = $MainContainer/VBoxContainer/RouletteContainer/RotatingItemRow/RotatingItemDescription
...
func update_permanent_upgrades():
	...
	_update_pillar_button("Synapse Slot", "SynapseRow/Synapse_Button")
	_update_pillar_button("Chroma Scales", "PillarsContainer/Pillar1/Pillar1_Button")
	_update_pillar_button("Serpent's Coffer", "PillarsContainer/Pillar2/Pillar2_Button")
	_update_pillar_button("Geode Compass", "PillarsContainer/Pillar3/Pillar3_Button")
	_update_pillar_button("Four-Leaf Clover", "PillarsContainer/Pillar4/Pillar4_Button")
...
func pick_and_display_rotating_item():
	...
	var button = $MainContainer/VBoxContainer/RouletteContainer/RotatingItemRow/RotatingItemButton
	var description = $MainContainer/VBoxContainer/RouletteContainer/RotatingItemRow/RotatingItemDescription
...
func _on_rotating_item_button_pressed():
	if GameManager.pulp >= current_rotating_item["cost"]:
		...
		$MainContainer/VBoxContainer/RouletteContainer/RotatingItemRow/RotatingItemButton.disabled = true
